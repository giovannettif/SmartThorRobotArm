# Modifications starting at lines 19 and 512.
# This code is the server which runs on the laptop directly connected into the Robot Arm, not the laptop that does the processing.
...
# Serial Connection functions
    ...
    def sendSerialCommand(self):
        ...
        ###################### Modifications here
        while True:
            messageToSent=str(socket.recv(),'utf-8')+"\n"

            messageToConsole= ">>> "+self.ConsoleInput.text()
            messageToConsole= ">>> "+messageToSent
            if s0.isOpen():
                if messageToSent!="":
